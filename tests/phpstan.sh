...
docker exec -t temp-ps rm -rf /var/www/html/modules/statsbestproducts
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/statsbestproducts \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/statsbestproducts phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/statsbestproducts/tests/phpstan/phpstan-$PS_VERSION.neon
